...
// Rosegarden::MidiEvent is a representation of MIDI which we use
        ...
        switch(m_metaEventCode)
        {
            ...
            default:
                cout << "Undefined MIDI META event - "
                     << (Rosegarden::timeT)m_metaEventCode << endl;
            break;
        }
    }
    else
...
Rosegarden::timeT
MidiEvent::addTime(const Rosegarden::timeT &time)
{
    m_deltaTime += time;
    return m_deltaTime;
}
