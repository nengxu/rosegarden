...
{
    setBackgroundColor(Rosegarden::GUIPalette::getColour(Rosegarden::GUIPalette::RawNoteRulerBackground));
}
...
//    int iy = int(myOrigin + (height - heightPer) / 2);
    ...
    paint.setPen(Rosegarden::GUIPalette::getColour(Rosegarden::GUIPalette::RawNoteRulerForeground));
    paint.setBrush(Rosegarden::GUIPalette::getColour(Rosegarden::GUIPalette::RawNoteRulerForeground));
