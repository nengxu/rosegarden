    ...
    TEXT_ACTUAL_X("TextActualX")
{
    ...
    setBackgroundColor(Rosegarden::GUIPalette::getColour(Rosegarden::GUIPalette::ChordNameRulerBackground));
...
ChordNameRuler::paintEvent(QPaintEvent* e)
{
    ...
    QPainter paint(this);
    paint.setPen(Rosegarden::GUIPalette::getColour(Rosegarden::GUIPalette::ChordNameRulerForeground));
