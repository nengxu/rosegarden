                          ...
                          QTab *t, bool has_focus ) const
{
    ...
    if ( t->iconSet() ) {
        ...
        int inactiveXShift = 0; // style().pixelMetric( QStyle::PM_TabBarTabShiftHorizontal, this );
        int inactiveYShift = 0; // style().pixelMetric( QStyle::PM_TabBarTabShiftVertical, this );
