...
void test_constructors ()
{
    ...
    if (a.getStart() !=  0) { result = false; }
    if (a.getEnd() != 0) { result = false; }
    if ( result )
    {
...
void test_load (void)
{
    ...
    if (a.getStart() != 2) { result = false; }
    if (a.getEnd() != 1) { result = false; }
    ...
    if (a.getStart() != UINT_MAX) { result = false; }
    if (a.getEnd() != (UINT_MAX - 1)) { result = false; }
    if ( result )
    {
