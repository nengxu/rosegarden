...
void test_append()
{
    ...
    if ( b_ptr->size() != 28 ) { result = false; }
    if ( c.size() != 31 ) { result = false; }
    ...
    if ( b_ptr->size() != 2 ) { result = false; }
    if ( c.size() != 33 ) { result = false; }
