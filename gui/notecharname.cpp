...
const CharName MORDANT = "MUSICAL SYMBOL MORDANT";
const CharName MORDANT_INVERTED = "MUSICAL SYMBOL INVERTED MORDANT";
const CharName MORDANT_LONG = "MUSICAL SYMBOL LONG MORDANT";
const CharName MORDANT_LONG_INVERTED = "MUSICAL SYMBOL LONG INVERTED MORDANT";
const CharName MORDANT_DOWN_HOOK_LONG = "MUSICAL SYMBOL DOWN HOOK LONG MORDANT";
const CharName MORDANT_UP_HOOK_LONG = "MUSICAL SYMBOL UP HOOK LONG MORDANT";
const CharName MORDANT_DOWN_HOOK_LONG_INVERTED = "MUSICAL SYMBOL DOWN HOOK LONG INVERTED MORDANT";
const CharName MORDANT_UP_HOOK_LONG_INVERTED = "MUSICAL SYMBOL UP HOOK LONG INVERTED MORDANT";
