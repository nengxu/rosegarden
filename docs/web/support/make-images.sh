...
IMAGEWRITER=/home/cannam/rosegarden/docs/web/support/imagewriter
...
$IMAGEWRITER/imagewriter -f $IMAGEWRITER/fonts/aristo.ttf -b204/212/160 -t204/212/160 -s 50 -w 400 -h 104 -x 2 -y 28 -o title-pictures.png Pictures
