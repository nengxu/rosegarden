...
int main ( int, char * [] )
{
    std::cout << "Running test: Fingering" << std::endl;
    test_constructors();
    test_addNote ();
    test_addBarre ();
    test_equal ();
