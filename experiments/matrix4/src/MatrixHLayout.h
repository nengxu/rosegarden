...
{
public:
    MatrixHLayout(Composition *c, double timeScaleFactor);
     ...
     * segment.
     */
    virtual void scanStaff(AbstractViewElementManager&,
                           LinedStaff &staff,
                           timeT = 0,
                           timeT = 0);
     ...
     * x-coord
     */
    virtual bool getTimeSignaturePosition(AbstractViewElementManager &staff,
                                          int barNo,
