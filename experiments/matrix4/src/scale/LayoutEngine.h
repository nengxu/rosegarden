...
public:
     ...
     * staff
     */
    virtual int getFirstVisibleBarOnStaff(AbstractViewElementManager &) {
     ...
     * staff
     */
    virtual int getLastVisibleBarOnStaff(AbstractViewElementManager &) {
     ...
     */
    virtual bool isBarCorrectOnStaff(AbstractViewElementManager &, int/* barNo */) {
        return true;
    }
    ...
    (AbstractViewElementManager &, int /* barNo */, TimeSignature &, double &/* timeSigX */) {
        return 0;
    }
};
