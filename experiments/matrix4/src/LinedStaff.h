...
protected:
     ...
     */
    LinedStaff(QGraphicsScene *, Segment *, SnapGrid *, AbstractViewElementManager *,
...
public:
     ...
     */
    virtual QRectF getBarExtents(double x, int y) const;
...
protected:
    ...
    // for this is that it seems to be more efficient from the QGraphicsScene
