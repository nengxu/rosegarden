...
GUIPalette::GUIPalette()
{
    ...
    QColor tmp;
    tmp.setHsv(211, 194, 238);
    m_defaultsMap[MuteTrackLED] = tmp;
    
    tmp.setHsv(45, 250, 225);
    m_defaultsMap[RecordMIDITrackLED] = tmp;

    tmp.setHsv(0, 250, 225);
    m_defaultsMap[RecordAudioTrackLED] = tmp;

    tmp.setHsv(211, 194, 238);
    m_defaultsMap[PlaybackFaderOutline] = tmp;
    
    tmp.setHsv(0, 250, 225);
    m_defaultsMap[RecordFaderOutline] = tmp;
}
