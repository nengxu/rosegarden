    ...
    m_endTime(endTime)
{
    ...
    if (m_startTime < m_endTime) {
        QLabel *durationLabel = new QLabel(tr("Duration %1:"), prebendBox);
        ...
        sequencegrid->addWidget(new QLabel(tr("Ramp duration %1:"), sequencebox), 1, 0);
        ...
        sequencegrid->addWidget(new QLabel(tr("End value %1:"), sequencebox), 2, 0);
        ...
        sequencegrid->addWidget(new QLabel(tr("Vibrato start amplitude %1:"), 
                                sequencebox), 3, 0);
        ...
        sequencegrid->addWidget(new QLabel(tr("Vibrato end amplitude %1:"),
                                sequencebox), 4, 0);
