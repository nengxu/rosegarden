...
/**
 * The RosegardenMainWidget class provides the view widget for the
 ...
 * RosegardenMainWidget is part of the docuement-view model, it needs a
 ...
 */
class RosegardenMainWidget : public QWidget
{
    Q_OBJECT
public:
     ...
     */
    RosegardenMainWidget(bool showTrackLabels,
                      SegmentParameterBox*,
