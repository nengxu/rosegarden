...
class HorizontalLayoutEngine2 : public LayoutEngine2,
				public RulerScale
{
public:
    HorizontalLayoutEngine2(Composition *c) : LayoutEngine2(), RulerScale(c) { }
    virtual ~HorizontalLayoutEngine2() { }
...
class VerticalLayoutEngine2 : public LayoutEngine2
{
public:
    VerticalLayoutEngine2() { }
    virtual ~VerticalLayoutEngine2() { }
